    ...
    //    }
         ...
         */
            ...
            while($row = $result1->fetch_assoc()) {
                ...
                // echo "<tr><td>" . $row["campusName"]. "</td><td>" . $row["categoryName"] . 
                // "</td><td><a href='" .$link. '' .$row["fileName"] . '' .$link1 ."'>" .$row["fileName"]. "</a></td></tr>";





                echo "<tr><td>" . $row["number"]. "</td><td>" . $row["title"] . 
                "</td><td>" . $row["descsmall"] . "</td><td>" . $row["campus_name"] . "</td><td>" .$row["functional_area"] 
                . "</td></tr>";
